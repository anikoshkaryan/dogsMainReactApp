...
export default class App extends Component {
    ...
    redirectToDogsBreedsSinglePage = (dog) => {
        this.props.navigation.navigate("QuestionsSingleDogs", {
            params: dog,
        });
    ...
    render() {
        console.log(this.state.dog_info)
        return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.top_panel}>
                    ...
                    <Text style={styles.toptext}>
                        Породы собак, найдено ({this.state.dog_info.length})
                    </Text>
                ...
                <LinearGradient colors={['#E1C1B7', '#FFFFFF']} style={styles.dogs_breeds_wrapper}>
                    ...
                    <ScrollView style={styles.dogs_items_scrollView}>
                        ...
                        {this.state.dog_info?.map((dog, index) => {
                            return (

                                <TouchableOpacity style={styles.dog_img_info_main_wrapper} key={dog.data.id}
                                    ...
                                    <View style={styles.dog_img_box}>
                                        <View style={styles.dog_img}>
                                            <Image style={styles.dog_img_child}
                                                   source={{uri: this.state.imageUrl + dog.data.dog_photo}}/>
                                        </View>
                                    </View>
                                    <View style={styles.dog_info_main_wrapper}>
                                        ...
                                        <Text style={styles.dog_info}> {dog.data.description} </Text>
