...
export default class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            single_dog_info: [],
            dog_review: [],
            all_dogs: this.props.all_dogs.data
        };
    }
    ...
    // CHI ASHXATI  token xrkel

    handleGetSingleDogInfo = async () => {
        let userToken = await AsyncStorage.getItem('userToken');
        let AuthStr = 'Bearer ' + userToken;
        try {
            fetch(`http://80.78.246.59/dogs-app/public/api/dog-all-data?id=${this.state.all_dogs.id}`, {
                method: 'post',
    ...
    render() {
        console.log(this.state.single_dog_info)
        return (
                    ...
                    <LinearGradient colors={['#E1C1B7', '#FFFFFF']} style={styles.dogs_breeds_wrapper}>
                        ...
                        <View style={styles.dogs_breeds_slider_item_info_wrapper}>
                            <Text style={styles.dogs_breeds_slider_item_info_title}>
                                ...
                                {this.state.all_dogs.parod_name}

                            </Text>
                            <Text style={styles.dogs_breeds_slider_item_info_text}>
                                {this.state.all_dogs.description}
                            </Text>

                        </View>
                        <View style={{paddingHorizontal: 20}}>
                            <SingleVideo style={styles.video_box}
                                         video_url={{url: 'http://80.78.246.59/dogs-app/public/storage/uploads/' + this.state.all_dogs.dog_video}}/>
                        </View>
